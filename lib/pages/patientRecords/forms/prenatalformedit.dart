...
class PreNatalFormEdit extends StatefulWidget {
  const PreNatalFormEdit({required this.uid, Key? key}) : super(key: key);

  final String uid;

  @override
  State<PreNatalFormEdit> createState() => _PreNatalFormEditState();
}

class _PreNatalFormEditState extends State<PreNatalFormEdit> {
                                ...
                                child: TextButton(
                                  onPressed: () async {
                                    bool addPreNatalSuccess =
                                        await updatePreNatalPatient(widget.uid);
